...
> **참고**: 제품 변경으로 인해 이 랩의 **데이터베이스 만들기 및 데이터 수집** 섹션에 알려진 몇 가지 문제가 있습니다. 이러한 문제를 해결하기 위해 노력하고 있습니다.
...
1. Synapse Studio 왼쪽에서 아이콘을 **&rsaquo;&rsaquo;** 사용하여 메뉴를 확장합니다. 그러면 리소스를 관리하고 데이터 분석 작업을 수행하는 데 사용할 Synapse Studio 내의 다양한 페이지가 표시됩니다.
